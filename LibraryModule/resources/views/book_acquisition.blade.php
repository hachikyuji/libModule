<x-app-layout>
   ...
   <div class="sm:ml-64 flex items-center justify-center">
        <div class="flex flex-col items-center justify-center h-full pt-10">
            <form action="{{ route('modify_book') }}" method="GET">
                    ...
                    <span class="whitespace-nowrap">Book Acquisition</span>
                    </button>
            </form>
      ...
      <form method="POST" action="{{ route('book_acquisition') }}" class="w-full max-w-md">
            ...
            <div class="mb-4">
                ...
                <input id="call_number" type="text" name="call_number" value="{{ old('call_number') }}" required autofocus autocomplete="call_number" class="w-full p-2.5 text-sm rounded-lg border border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                @error('call_number')
            ...
            <div class="mb-4">
                ...
                <input id="author" type="text" name="author" value="{{ old('author') }}" required autofocus autocomplete="author" class="w-full p-2.5 text-sm rounded-lg border border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                @error('author')
                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input id="title" type="text" name="title" value="{{ old('title') }}" required autofocus autocomplete="title" class="w-full p-2.5 text-sm rounded-lg border border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                @error('title')
                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input id="sublocation" type="text" name="sublocation" value="{{ old('sublocation') }}" autofocus autocomplete="sublocation" class="w-full p-2.5 text-sm rounded-lg border border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                @error('sublocation')
                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input id="edition" type="text" name="edition" value="{{ old('edition') }}" autofocus autocomplete="edition" class="w-full p-2.5 text-sm rounded-lg border border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                @error('edition')
                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input id="publisher" type="text" name="publisher" value="{{ old('publisher') }}" autofocus autocomplete="publisher" class="w-full p-2.5 text-sm rounded-lg border border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                @error('publisher')
                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input id="extent" type="text" name="extent" value="{{ old('extent') }}" autofocus autocomplete="extent" class="w-full p-2.5 text-sm rounded-lg border border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                @error('extent')
                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input id="isbn" type="text" name="isbn" value="{{ old('isbn') }}" autofocus autocomplete="isbn" class="w-full p-2.5 text-sm rounded-lg border border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                @error('isbn')
                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input id="publish_date" type="date" name="publish_date" value="{{ old('publish_date') }}" autofocus autocomplete="publish_date"  class="w-full p-2.5 text-sm rounded-lg border border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                @error('publish_date')
                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input id="available_copies" type="number" name="available_copies" value="{{ old('available_copies') }}" required autofocus autocomplete="available_copies"  class="w-full p-2.5 text-sm rounded-lg border border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
            ...
            <div class="mb-4">
                ...
                <input id="total_copies" type="number" name="total_copies" value="{{ old('total_copies') }}" required autofocus autocomplete="total_copies"  class="w-full p-2.5 text-sm rounded-lg border border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                @error('total_copies')
                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
