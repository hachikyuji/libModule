   ...
   <div class="sm:ml-64 flex items-center justify-center">
        ...
        <a href="{{ url()->previous() }}"
            ...
            <h1 class="text-3xl font-bold text-blue-800 dark:text-blue-600 mb-3 ml-1">
             ...
             <div class="max-w-2xl p-4 bg-yellow-400 dark:bg-yellow-500 rounded-md shadow-md text-white">
               ...
               <div class="flex flex-col items-center"">
                  ...
                  <form method="POST" action="{{ route('request.checkOut', ['title' => $books->title]) }}">
                     @csrf
