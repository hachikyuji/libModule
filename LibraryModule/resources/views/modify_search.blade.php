   ...
   <div class="sm:ml-64 flex items-center justify-center">
        <div class="flex flex-col items-center justify-center h-full pt-10">
            <h1 class="text-3xl font-bold text-blue-800 dark:text-blue-600 mb-3 ml-1 pt-10">
                Book Count Modification
            </h1>

<form action="{{ route('modify_search', request()->query()) }}">
        <div class="flex my-2">
                            ...
                            @foreach($books as $book)
                                <tr>    
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('modbook.show', ['id' => $book->id]) }}" class="text-sm text-blue-500">{{ \Str::limit($book->title, 50) }}</a>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
