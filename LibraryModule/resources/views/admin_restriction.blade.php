<x-app-layout>
   ...
   <div class="sm:ml-64 flex justify-center items-center h-screen" role="group">
      <div class="flex flex-col">
         @if (Session::has('success'))
               <div class="text-green-600 dark:text-green-600 font-medium mb-20 text-center">
                  {{ session('success') }}
               </div>
         @endif

         @if (Session::has('error'))
               <div class="text-red-600 dark:text-red-600 font-medium mb-20 text-center">
                  {{ session('error') }}
               </div>
         @endif
      </div>
