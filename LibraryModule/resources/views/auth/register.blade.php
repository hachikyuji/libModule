...
<div class="h-full p-4 sm:ml-64 flex items-center justify-center pt-20">
        ...
        <div class="flex items-center justify-center pt-1">
            ...
            <div class="mb-4">
               ...
               <x-text-input id="first_name" class="w-full p-2.5 text-sm rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="text" name="first_name" :value="old('first_name')" required autofocus />
               <x-input-error :messages="$errors->get('first_name')" class="mt-2" />
            </div>

            <div class="mb-4">
               <x-input-label for="last_name" :value="__('Last Name')" style="color: #0000FF; font-size: 16px; margin-bottom: 8px;"/>
               <x-text-input id="last_name" class="w-full p-2.5 text-sm rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="text" name="last_name" :value="old('last_name')" required />
               <x-input-error :messages="$errors->get('last_name')" class="mt-2" />
            </div>

            <div class="mb-4">
               <x-input-label for="middle_initial" :value="__('Middle Initial')" style="color: #0000FF; font-size: 16px; margin-bottom: 8px;" />
               <x-text-input id="middle_initial" class="w-full p-2.5 text-sm rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="text" name="middle_initial" :value="old('middle_initial')" />
            ...
            <div class="mb-4">
               ...
               <x-text-input id="user_num" class="w-full p-2.5 text-sm rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="text" name="user_num" :value="old('user_num')" required autofocus />
            ...
            <div class="mb-4">
               ...
               <x-text-input id="college" class="w-full p-2.5 text-sm rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="text" name="college" :value="old('college')"/>
            ...
            <div class="mb-4">
               ...
               <x-text-input id="course" class="w-full p-2.5 text-sm rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="text" name="course" :value="old('course')"/>
               <x-input-error :messages="$errors->get('course')" class="mt-2" />
            </div>

            <div class="mb-4">
               <x-input-label for="email" :value="__('Email')" style="color: #0000FF; font-size: 16px; margin-bottom: 8px;" />
               <x-text-input id="email" class="w-full p-2.5 text-sm rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="email" name="email" :value="old('email')" required autocomplete="username" />
            </div>
            @if ($errors->has('email'))
            ...
            <div class="mb-4">
               ...
               <x-text-input id="password" class="w-full p-2.5 text-sm rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="password" name="password" required autocomplete="new-password" />
               <x-input-error :messages="$errors->get('password')" class="mt-2" />
            </div>

            <div class="mb-4">
               <x-input-label for="password_confirmation" :value="__('Confirm Password')" style="color: #0000FF; font-size: 16px; margin-bottom: 8px;" />
               <x-text-input id="password_confirmation" class="w-full p-2.5 text-sm rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="password" name="password_confirmation" required autocomplete="new-password" />
               <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />
            </div>

            <div class="mb-4">
               <x-input-label for="account_type" :value="__('Account Type')" style="color: #0000FF; font-size: 16px; margin-bottom: 8px;" />
               <select id="account_type" class="w-full p-2.5 text-sm rounded-lg border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" name="account_type" required>
