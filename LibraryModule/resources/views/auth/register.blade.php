...
<<aside id="default-sidebar" class="fixed top-20 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-blue-900">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-blue-100 dark:hover:bg-blue-700 group">
         ...
         <li>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512" fill="white">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap text-white">Book Acquisition</span>
            </a>
         </li>
         <li>
...
<div class="h-full p-4 sm:ml-64 flex items-center justify-center">
        <form method="POST" action="{{ route('register') }}" class="w-full max-w-md">
            ...
            <div class="mb-4">
                <x-input-label for="password_confirmation" :value="__('Confirm Password')" style="color: #000; font-size: 16px; margin-bottom: 8px;" />
                <x-text-input id="password_confirmation" class="w-full p-2.5 text-sm rounded-lg"
                    type="password"
